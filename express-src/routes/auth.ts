...
// Login endpoint
router.post('/login', loginRateLimiter, asyncHandler(async (req: any, res: any) => {
...
router.post('/password/reset', passwordResetRateLimiter, asyncHandler(async (req: any, res: any) => {
